...
CR_mapping = [
    (0.1, 1),   (0.3, 1),   (0.5, 1),   (0.7, 1),   (0.9, 1),   (1.0, 1),
    (0.1, 2),   (0.3, 2),   (0.5, 2),   (0.7, 2),   (0.9, 2),   (1.0, 2),
    (0.1, 4),   (0.3, 4),   (0.5, 4),   (0.7, 4),   (0.9, 4),   (1.0, 4),
    (0.1, 6),   (0.3, 6),   (0.5, 6),   (0.7, 6),   (0.9, 6),   (1.0, 6)
]


CR_mapping_index = [i for i in range(0, len(CR_mapping))]
